document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    hu: {
      ...
      'hero.sub': 'Az AlgiSoil fosszilis alginitre épülő, bio megoldása javítja a talaj vízmegtartó képességét, támogatja a gyökérfejlődést, és növeli a növények ellenálló képességét.',
      ...
      'why.stat1.title': 'Egyre több szélsőségesen meleg nap',
      ...
      'why.stat4.desc': 'Önmagában 2022-ben 49,7 milliárd forintot tett ki az aszálykár-kompenzáció Magyarországon.',
      'why.stat4.unit': 'milliárd Ft',
      'why.p1': 'Az aszály nem csupán környezeti probléma, hanem gazdasági probléma is. Növekvő hőségnapok száma. Kiszámíthatatlanabb csapadék eloszlás. Egyre nagyobb nyomás a terményeken, a talajokon és a gazdálkodókon egyaránt.',
      'why.p2': 'A kérdés már nemcsak az, mennyi csapadékunk van, hanem az, mennyit tud ebből megtartani a talaj. <span class="hl">Itt lép be a képbe az AlgiSoil.</span>',
      ...
      'vision.p2': 'Az AlgiSoilnál hidat építünk a természet, a tudomány és a mindennapi gazdálkodás között. A természetes anyagokban rejlő lehetőségeket gyakorlati, skálázható talajtechnológiákká alakítjuk, amelyek segítik a gazdálkodókat a XXI. század kihívásaihoz való alkalmazkodásban.',
      'vision.p3': 'Törekvésünk túlmutat egyetlen terméken. A talajmegoldások új generációját szeretnénk megalkotni, szélesebb körben elérhetővé téve az éghajlati és aszályos körülményekkel szembeni ellenálló képességet — a szőlőktől és gyümölcsösöktől kezdve a különböző régiók és termesztési feltételek melletti gazdaságokig.',
      'vision.p4': 'Hiszünk abban, hogy a mezőgazdaság jövője nem a több felhasználására épül majd, hanem arra; hogyan tudjuk a már rendelkezésünkre álló erőforrásokat hatékonyabban és tudatosabban használjuk.',
      'vision.leadout': 'Olyan termékek, amelyekre a talajnak szüksége van. Olyan megoldások, amelyekre a gazdálkodók számíthatnak. Az aszályra tervezve. Skálázhatóságra tervezve. A jövőre tervezve.',
      'vision.microquote': 'A talaj Európa legnagyobb — mégis az egyik legkevésbé nyomon követett — ökoszisztémája.',

      'story.tag': 'Történetünk',
      'story.title': 'Az AlgiSoil lényegét tekintve egy baráti történet.',
      'story.p1': 'Az AlgiSoil barátok kíváncsiságából és abból a közös vágyból született, hogy valami igazán hasznosat hozzunk létre.',
      ...
      'team.bio1': 'Gazdálkodó családban nőttem fel — ez a háttér alakította azt, ahogyan a mezőgazdaságra tekintek: nem optimalizálandó iparágként, hanem megértendő rendszerként. Az éghajlatváltozás sürgetővé tette a talaj egészségének kérdését. Lucával és csapatunkkal együtt kutatókkal és gazdálkodókkal dolgozunk azon, hogy tudományosan megalapozott, alginitalapú talajjavító megoldásokkal helyreállítsuk azt, amit a modern mezőgazdaság lassan kimerített. A regeneratív mezőgazdaság számunkra nem csupán egy termékkategória. Ez a küldetésünk.',
      'team.role2': 'Alapító és operatív igazgató (COO)',
      'team.bio2': 'Szőlész-borászként a mezőgazdaság sosem csak a munkám része volt. A családomban mindig is készítettünk bort, így a szőlő és a vele járó munka gyerekkorom óta része az életemnek. Később a tanulmányaim és a munkám során első kézből tapasztaltam meg, milyen gyorsan változnak azok a körülmények, amelyek között ma a gazdálkodók dolgoznak. Az AlgiSoil építésében ezért számomra nemcsak az fontos, hogy mit hozunk létre, hanem az is, hogyan tesszük ezt: milyen kérdéseket teszünk fel, kikkel dolgozunk együtt, és milyen értékek mentén hozzuk meg a döntéseinket. Olyan megoldást szeretnénk létrehozni, amely valós problémából indul ki, és a gyakorlatban is használható választ ad rá.',
      'team.role3': 'Alapító és pénzügyi igazgató (CFO)',
      'team.bio3': 'A jó talaj nem csupán erőforrás — minden alapja. A magán- és a közszférában egyaránt dolgozva komplex szervezeti struktúrák kezelésére, valamint uniós pályázati és finanszírozási rendszerekben való eligazodásra specializálódtam. A küldetésem, hogy a regeneratív mezőgazdaságról alkotott jövőképünket szilárd pénzügyi stratégia támogassa.',
      'team.role4': 'Technológiai igazgató (CTO) — termékfejlesztés és terepi validáció',
      'team.bio4': 'Vegyész- és biomérnökként azzal foglalkozom, hogyan válthatók ki a szintetikus kémiai eljárások biotechnológiai megoldásokkal és természetes élő rendszerekkel. Célunk nem az, hogy agresszív vegyszerekkel kimerítsük a talaj összetett biológiai ökoszisztémáját, hanem hogy kiegészítsük, tápláljuk és támogassuk annak regenerálódását.',
      'team.role5': 'Logisztika és értékesítés — kertészeti koordinátor',
      'team.bio5': 'Jelenleg kereskedelem és marketing szakon tanulok, emellett a családi gazdaságunkban dolgozom, harmadik generációsként a gyümölcstermesztésben. Személyes célom, hogy összekapcsoljam a gazdálkodók gyakorlati tudását a tudományos szakértelemmel, és így hatékony megoldásokat találjunk a mai mezőgazdasági kihívásokra.',
      ...
      'alginite.p1': 'Az alginit fosszilis algabiomassza és ásványi összetevők természetes keveréke. Szervesanyag-tartalma, porózus szerkezete és ásványi összetétele ígéretes alapanyaggá teszi olyan technológiák fejlesztéséhez, amelyek támogatják a talaj vízgazdálkodását és biológiai működését.',
      ...
      'approach.title': 'A bányától a szántóföldig — a tudomány köti össze',
      ...
      'approach.step2.title': 'Validált termékfejlesztés',
      'approach.step2.desc': 'Tudományos partnereinkkel közösen fejlesztjük megoldásainkat, és talajtani vizsgálatokkal alátámasztjuk az eredményeinket.',
      'approach.step3.title': 'Valós körülmények között teszteljük',
      'approach.step3.desc': 'Minden megoldást valós terepi körülmények között tesztelünk, mielőtt eljutna a gazdálkodókhoz.',
      'approach.leadout': 'Nincs „csodaszer”.<br>Csak átlátható, regeneratív innováció, amely a gyakorlatban is működik.',
      ...
      'join.title': 'A természet erejével. Gazdálkodókkal együtt. Tudományosan igazolva.',
      'join.copy': 'A talaj regenerálása korunk egyik legnagyobb kihívása. Azért vagyunk itt, hogy ezt gyakorlatban alkalmazhatóvá, elérhetővé és kézzelfoghatóvá tegyük — olyan megoldásokkal, amelyek valódi körülmények között is működnek. Egyszerre egy táblán.',
      'join.cta': '🌱 Csatlakozz közösségünkhöz',
      'join.microquote': 'A mezőgazdaság egyik legnagyobb kockázata a talaj figyelmen kívül hagyása.',

      'experiment.tag': 'Kísérletezz otthon',
      'experiment.title': 'Kísérletezz velünk!',
      'experiment.intro': 'Érdekel, amin dolgozunk, és szívesen kipróbálnád te is?',
      'experiment.body': 'Nem kell hozzá több ezer hektár. Sőt, még egy hektár sem. Ha van egy kerted, néhány magaságyásod vagy akár csak pár szobanövényed, már csatlakozhatsz az AlgiSoil kísérleti köréhez. Tavasszal indulunk!',
      'experiment.note': 'Írj nekünk „Kísérletezz otthon!” tárggyal, és felvesszük veled a kapcsolatot.',
      'experiment.cta': '🌱 Kísérletezz otthon!',
